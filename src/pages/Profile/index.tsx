  ...
  const handleSignUp = useCallback(
    async (data: ProfileFormData) => {
      try {
        ...
        // Object.assign une dois objetos (foi transformado em spread operator)
        // se old_password for informado, o segundo objeto será unido ao primeiro, senão será unido a um objeto vazio
        const formData = {
          name,
          email,
          ...(old_password
